<script lang="ts">
    ...
    const stars = Array(5).fill(0).map((_, i) => i < starRating ? 'full' : 'empty');
</script>

<div class="flex items-center">
    {#each stars as star}
        {#if star === 'full'}
            <svg class="w-5 h-5 text-white ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
